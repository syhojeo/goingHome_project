...
bool nevi_srv(goinghome_command::command::Request &req,goinghome_command::command::Response &res){
  ...
  //goal_msg.target_pose.pose.orientation.x =req.ox;
  //goal_msg.target_pose.pose.orientation.y =req.oy;
  //goal_msg.target_pose.pose.orientation.z =req.oz;
...
//변위값
  ...
  ROS_INFO("send pose.position.z %f",goal_msg.target_pose.pose.position.z);
  ROS_INFO("send pose.orientation.x %f",goal_msg.target_pose.pose.orientation.x);
  ROS_INFO("send pose.orientation.y %f",goal_msg.target_pose.pose.orientation.y);
  ROS_INFO("send pose.orientation.z %f",goal_msg.target_pose.pose.orientation.z);
